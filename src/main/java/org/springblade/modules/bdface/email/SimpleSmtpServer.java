...
public final class SimpleSmtpServer implements AutoCloseable {
	...
	private HuaWCameraEmailServer emailServer;
	 ...
	 */
	public static SimpleSmtpServer start(int port,HuaWCameraEmailServer emailServer) throws IOException {


		return new SimpleSmtpServer(new ServerSocket(Math.max(port, 0)), emailServer);
	}
	 ...
	 */
	private SimpleSmtpServer(ServerSocket serverSocket,HuaWCameraEmailServer emailServer) {
